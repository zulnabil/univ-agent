...
class Settings(BaseSettings):
    ...
    # Milvus settings
    MILVUS_URI: str = os.getenv("MILVUS_URI", "https://in03-26f04ddfb7604fe.serverless.gcp-us-west1.cloud.zilliz.com")
    MILVUS_TOKEN: str = os.getenv("MILVUS_TOKEN", "0cac19debb0e81a2608587afa786e9309b9e6eb7eca728e40b4ff8406d8767353e5bc192860cffd3aa99a411d21aca07dcecaf23")
    MILVUS_COLLECTION: str = os.getenv("MILVUS_COLLECTION", "univ_collections")
